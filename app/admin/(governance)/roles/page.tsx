  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-500">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Super Admin workspace to define custom roles, permissions, and platform-wide capabilities.
            </p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 shadow-sm py-24 flex flex-col items-center justify-center space-y-3 px-4 text-center">
        ...
        <p className="text-sm text-slate-500 max-w-sm">The Role Policies (RBAC) module is currently under development.</p>
      </div>
    </div>
  );
}
