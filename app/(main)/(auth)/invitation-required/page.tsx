      ...
      <AuthCard>
        ...
        <div className="flex flex-col items-center space-y-6 text-center">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Your Google account is not currently invited to the Food Analyst Forum. FAF is an invitation-only professional community.
          </p>

          <div className="flex w-full flex-col gap-3 pt-4">
            <Button className="w-full">
              <Link href="/request-invite" className="flex w-full items-center justify-center">Request an Invitation</Link>
            </Button>
            
            <Button variant="outline" className="w-full">
              <Link href="/login" className="flex w-full items-center justify-center">Back to Sign In</Link>
            </Button>
          </div>
        </div>
      </AuthCard>
